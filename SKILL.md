...
tags: resilience, mental-toughness, adversity-navigation, psychological-recovery, stress-management
...
**User input:** "I've been through a rough year (divorce, layoff). Build me a resilience recovery plan."

**Expected output:** Phased recovery plan — Stabilize (sleep, nutrition, movement basics), Process (structured reflection on both losses with meaning-making exercises), Rebuild (identity reconstruction beyond job/relationship), Grow (post-traumatic growth exploration) — each phase with daily practices and progress indicators.

### Scenario 2

**User input:** "Our startup team is burning out after 3 failed product launches. Design a team resilience workshop."

**Expected output:** Half-day workshop — failure-normalization exercise (famous pivot stories), stress-signature mapping (individual + team), collective coping-strategy bank, resilience ritual design (team-level recovery practices), and 90-day psychological-safety and support-system action plan.

### Scenario 3

**User input:** "My teenager gives up at the first sign of difficulty. How do I build their resilience?"

**Expected output:** Parent's resilience-building guide — age-appropriate challenge calibration (optimal frustration zone), failure-normalization conversations (share your own failures), problem-solving coaching (ask, don't solve), effort-praise vs. outcome-praise scripts, and resilience-story library (books and films organized by challenge type).
### Scenario 4: 创业失败后怎么走出来
**User input:** "去年和朋友合伙开餐饮店，投了30万全亏了，现在钱没了朋友也没了，每天醒来就觉得人生没有意义。"
**Expected output:** 提供创业失败后的心理重建方案：1）物理重启——建议先做一件'简单且有成就感'的事（去跑5公里、给家里做大扫除、做一顿精致的饭），重建对自己的信心；2）认知重建——把'我失败了我就是废物'转变为'我的这次创业尝试失败了，但我学到了宝贵的经验（选址/供应链/管人）'；3）行动方案——先找一份有固定收入的工作恢复经济（不必一步到位），同时为下一次创业积累资源；4）支持系统——加入创业者校友会或'失意创业者互助群'（在脉脉/微信可以找到），和同样经历的人交流会让你发现你不是一个人。推荐看褚时健的故事。
